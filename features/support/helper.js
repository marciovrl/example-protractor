...
Helper.prototype.isElementAttachedToHtml = function(element) {
  browser.wait(
    ...
    25000,
    "Element " + element.getText() + " taking too long to appear in the DOM"
  );
...
Helper.prototype.isClickable = function(element) {
  browser.wait(
    ...
    50000,
    "Element taking too long to appear in the DOM and stay clickable"
  );
};
...
Helper.prototype.isVisible = function(element) {
  browser.wait(
    ...
    10000,
    "Element taking too long to appear in the DOM and stay visible"
  );
};
